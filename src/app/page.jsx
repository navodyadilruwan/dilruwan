...
//       <Link href="#">Navodya Dilruwan</Link>

//       <div className="flex items-center">
//         <Link href="#" className="font-semibold hover:text-amber-200 ">ABOUT</Link>
...
//         EXPERIENCE
//       </Link>
//       <Link href="#acadamic_projects" className="hover:text-blue-200 hover:underline">
//         PROJECTS
//       </Link>
...
// {/* <section id="about"className="bg-black-400">
//     <div>
//       <h1>Navodya Dilruwan</h1>
//       <h2>Full-Stack Developer</h2>
//       <h3>I build scalable, accessible web applications that blend thoughtful design with robust engineering.</h3>

//       <p>Kadolla Junction Wathugedara,
//          Thota Wathugedara
//          <br/>
...
//     <div>
//       <p>I am an enthusiastic and reliable Full-Stack Developer with strong problem-solving skills and a passion for building scalable applications. Currently pursuing my BSc (Hons) Information Technology specializing in Software Engineering at Sri Lanka Institute of Information Technology.<br/>
...
//       </div>
//       <div>
//         <h3>BSc (Hons) Information Technology, SLIIT</h3>
//       </div>
//       <div>
//         <p>Specializing in Software Engineering with focus on modern web technologies, database systems, and software architecture patterns.</p>
//       </div>
//       <div>
//         Next.js
// React
...
//       I build scalable, accessible web applications that blend thoughtful design
...
//       I am an enthusiastic and reliable Full-Stack Developer with strong
//       problem-solving skills and a passion for building scalable applications.
//       Currently pursuing my BSc (Hons) Information Technology specializing in
//       Software Engineering at Sri Lanka Institute of Information Technology.
//       <br />
//       With hands-on experience in both frontend (Next.js, React) and backend
//       (Bun, Hono, Drizzle ORM, PostgreSQL) development, I am adaptable to
//       challenging situations, a mature team player, and committed to delivering
//       high-quality solutions. I am eager to continuously learn new technologies
//       and contribute effectively to any team or project.
//     </p>

//     {/* Timeline / Education */}
//     <div className="mt-8 space-y-4">
//       <div className="text-amber-300">2022 — PRESENT</div>
//       <div>
...
//       <div>
//         <p className="text-gray-300">
//           Specializing in Software Engineering with focus on modern web
//           technologies, database systems, and software architecture patterns.
//         </p>
//       </div>
...
//   </div><br/>
//   <div>
//     <h2>Online Property Sales System</h2>
//     <p>Web-based property management and sales platform with user authentication and property listings.</p>
//     <p> HTML
//         CSS
//         JavaScript</p>
//   </div><br/>
...
//     <p>E-commerce platform for music sales with shopping cart functionality and user management.</p>
//     <p>Java
// JSP
// Servlet</p>
//   </div><br/>
...
//     <p>Mobile application for gym operations management with member tracking and workout scheduling.</p>
//     <p>Next.js
//       Drizzle ORM
//       PostgreSQL</p>
//   </div><br/>
...
//     <p>Full-stack hotel management system with room booking, payment handling, policies, and staff management. Built with Drizzle ORM + PostgreSQL and secure session-based authentication.</p>
//     <p>Next.js
//       Drizzle ORM
//       PostgreSQL</p>
//   </div><br/>
...
//     {/* University */}
//     <div className="mb-8">
//       <h2 className="text-2xl font-semibold text-amber-400">SLIIT</h2>
//     </div>
...
//         </p>
//         <p className="mt-3 text-sm text-amber-300">Figma • Fluter </p>
//       </div>

//       {/* Project 4 */}
//       <div className="bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-amber-400/40 transition">
//         <h3 className="text-xl font-semibold">Phrmacy Management System</h3>
//         <p className="mt-2 text-gray-300">
//           Full-stack developed this website
//           Customer Management: Maintain customer profiles and purchase history for better service.
//           API Testing: Integrated Postman for testing backend endpoints to ensure robust functionality.
//         </p>
//         <p className="mt-3 text-sm text-amber-300">React js • MongoDB • Postman • Teilwind CSS</p>
//       </div>
//     </div>
//   </div>
// </section>
...
//   <div>
//     <h2>My Universe</h2>
//     <h3>University Registration Platform</h3>
//     <p>Platform for university search and admission registration with role-based access control for students and university admins. Includes application tracking and course management APIs.</p>
//     <p>Next.js
//       Drizzle ORM
//       PostgreSQL</p>
//   </div><br/>
...
//   <div>
//     <h1>Let's Contact</h1>
//     <p>I'm always interested in discussing new opportunities, innovative projects, or just connecting with fellow developers. Feel free to reach out if you'd like to collaborate or chat about technology.</p>
//   </div>
//   <div>
//     <button className="bg-green-500 hover:bg-green-600 px-6 py-3 rounded-full text-sm font-medium transition-colors">
//         Get Started
//       </button>
